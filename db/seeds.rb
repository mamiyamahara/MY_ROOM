	...
	[
		{
	        ...
	        profile_image: open("./app/assets/images/profile_image.jpeg"),
...

        {
	        ...
	        profile_image: open("./app/assets/images/profile_image2.jpeg"),
...

        {
	        ...
	        profile_image: open("./app/assets/images/profile_image3.jpeg"),
	...
	[
		{
	        ...
	        post_image: open("./app/assets/images/interior_photo1.jpg")
        },

        {
	        ...
	        post_image: open("./app/assets/images/kitchen_interior.jpg")
        },

		{
	        ...
	        post_image: open("./app/assets/images/interior_photo2.jpg")
        },
    ]
    )
